...
<p align="center"><b>TFT 模组 · RGB · ST7102 · 多版本索引</b></p>
...
本仓库收录 **3.95 寸 480×480 TFT（RGB · ST7102）** 显示模组资料。
...
| 版本 | 宣传图 | 简介 | 完整资料 |
| ---- | ------ | ---- | -------- |
| YDP395B005-V4 | <img alt="YDP395B005-V4" src="./versions/YDP395B005-V4/images/product.png" width="120" /> | [简介](#ydp395b005-v4) | [完整资料](./versions/YDP395B005-V4/) |
...
**说明：** In-Cell 电容触摸；RGB 18-bit。

完整产品页、规格书与示例：[versions/YDP395B005-V4/](./versions/YDP395B005-V4/)
